...
const styles = StyleSheet.create({
  ...
  tabBadgeText: { fontSize: wxMs(10), fontWeight: "700", color: "#FFFFFF" },
  ...
  statLabel: { fontSize: wxMs(FONT_SIZES.xs), color: COLORS.textMuted, marginTop: wxSc(2) },
  ...
  accentBar: { height: wxSc(3), width: "100%" },
  ...
  inboxFromRow: { flexDirection: "row", alignItems: "center", gap: wxSc(6), flex: 1 },
  supportTag: {
    backgroundColor: "#3498DB20",
    borderRadius: wxSc(4),
    paddingHorizontal: wxSc(6),
  ...
  inboxTimeRow: { flexDirection: "row", alignItems: "center", gap: wxSc(6) },
  inboxTimeText: { fontSize: wxMs(FONT_SIZES.xs), color: COLORS.textMuted },
  unreadBadge: {
  ...
  unreadBadgeText: { fontSize: wxMs(10), fontWeight: "700", color: "#FFFFFF" },
  inboxSubject: {
  ...
  badgeRow: { flexDirection: "row", gap: wxSc(6) },
  categoryBadge: {
    borderRadius: wxSc(8),
    paddingHorizontal: wxSc(8),
    paddingVertical: wxSc(2),
    borderWidth: 1,
  },
  categoryBadgeText: { fontSize: wxMs(10), fontWeight: "600" },
  tournamentBadge: {
  ...
  loadingText: { fontSize: wxMs(FONT_SIZES.sm), color: COLORS.textMuted },
  ...
  targetCount: { fontSize: wxMs(FONT_SIZES.xs), color: COLORS.textMuted },
  ...
  targetChipMeta: { flexDirection: "row", gap: SPACING.sm, marginTop: wxSc(3) },
  targetChipId: { fontSize: wxMs(11), color: COLORS.textMuted, fontWeight: "600" },
  targetChipDate: { fontSize: wxMs(11), color: COLORS.textMuted },
  targetChipText: {
    fontSize: wxMs(FONT_SIZES.sm),
    color: COLORS.text,
    fontWeight: "500",
  ...
  selectedTargetRight: { alignItems: "flex-end", gap: wxSc(4) },
  ...
  targetSearchIcon: { fontSize: wxMs(14), marginRight: SPACING.xs },
  targetSearchInput: {
    flex: 1,
    fontSize: wxMs(FONT_SIZES.sm),
    color: COLORS.text,
  ...
  targetDropdownScroll: { maxHeight: wxSc(280) },
  ...
  messageInput: { minHeight: wxSc(120) },
  broadcastButton: {
    backgroundColor: COLORS.primary,
    borderRadius: RADIUS.md,
    padding: SPACING.md,
  ...
  emptyIcon: { fontSize: wxMs(48), marginBottom: SPACING.md },
  emptyTitle: {
