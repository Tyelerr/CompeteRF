...
//
// Bar-owner-scoped analytics page.
// Mirrors the super admin analytics.tsx layout but only shows
// events for tournaments at the bar owner's venues.
// Uses its own viewmodel — completely separate from useAnalyticsDashboard.
