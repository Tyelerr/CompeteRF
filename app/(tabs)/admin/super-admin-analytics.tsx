  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, isWeb && styles.headerWeb]}>
        ...
        <Text allowFontScaling={false} style={styles.headerSubtitle}>App-wide event tracking</Text>
      </View>
...
const MiniStatCard = ({ icon, value, label, highlight }: MiniStatCardProps) => (
  <View style={[styles.miniCard, highlight && styles.miniCardHighlight]}>
    ...
    <Text allowFontScaling={false} style={[styles.miniValue, highlight && styles.miniValueHighlight]}>
