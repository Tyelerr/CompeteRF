...
const styles = StyleSheet.create({
  pageWrapper: { maxWidth: 860, width: "100%" as any, alignSelf: "center" as any },
  outerContainer: { flex: 1, backgroundColor: COLORS.background },
  container: { flex: 1, maxWidth: isWeb ? 860 : undefined, width: isWeb ? "100%" as any : undefined, alignSelf: isWeb ? "center" as any : undefined },
  header: {
    flexDirection: "row", alignItems: "center",
    paddingHorizontal: wxSc(SPACING.md),
    paddingTop: isWeb ? wxSc(SPACING.lg) : wxSc(SPACING.xl + SPACING.lg),
    paddingBottom: wxSc(SPACING.md),
    borderBottomWidth: 1, borderBottomColor: COLORS.border,
    backgroundColor: COLORS.backgroundCard,
  },
  backButton: { marginRight: wxSc(SPACING.md) },
  backButtonText: { fontSize: wxMs(FONT_SIZES.lg), color: COLORS.primary, fontWeight: "600" },
  headerTitle: { fontSize: wxMs(FONT_SIZES.xl), fontWeight: "700", color: COLORS.text },
  alertInfo: {
    paddingHorizontal: wxSc(SPACING.md),
  ...
  alertName: { fontSize: wxMs(FONT_SIZES.md), fontWeight: "700", color: COLORS.text, marginBottom: wxSc(2) },
  alertDescription: { fontSize: wxMs(FONT_SIZES.sm), color: COLORS.primary },
  controls: {
    flexDirection: "row", alignItems: "center",
    paddingHorizontal: wxSc(SPACING.md),
    paddingVertical: wxSc(SPACING.sm),
  ...
  searchIcon: { fontSize: wxMs(FONT_SIZES.sm), marginRight: wxSc(SPACING.xs) },
  searchInput: { flex: 1, fontSize: wxMs(FONT_SIZES.sm), color: COLORS.text },
  clearButton: { padding: wxSc(SPACING.xs), marginLeft: wxSc(SPACING.xs) },
  clearIcon: { fontSize: wxMs(FONT_SIZES.sm), color: COLORS.textMuted },
  sortButton: {
    flexDirection: "row", alignItems: "center",
  ...
  sortIcon: { fontSize: wxMs(FONT_SIZES.sm) },
  sortText: { fontSize: wxMs(FONT_SIZES.sm), color: COLORS.white, fontWeight: "600" },
  errorContainer: {
  ...
  cardContent: { flexDirection: "row", padding: wxSc(SPACING.md) },
  mainContent: { flex: 1, marginRight: wxSc(SPACING.md) },
  headerRow: { flexDirection: "row", marginBottom: wxSc(SPACING.sm) },
  gameTypeBadge: {
  ...
  tournamentName: {
    ...
    lineHeight: wxMs(FONT_SIZES.md) * 1.3,
  },
  infoRow: { flexDirection: "row", alignItems: "flex-start", marginBottom: wxSc(4) },
  infoIcon: { fontSize: wxMs(FONT_SIZES.xs), marginRight: wxSc(SPACING.xs), marginTop: wxSc(2), width: wxSc(16) },
  infoText: { flex: 1, fontSize: wxMs(FONT_SIZES.sm), color: COLORS.textSecondary },
  entryFeeText: { fontSize: wxMs(FONT_SIZES.sm), color: COLORS.primary, fontWeight: "600" },
  matchedRow: {
    borderTopWidth: 1, borderTopColor: COLORS.border,
    paddingTop: wxSc(SPACING.sm),
    marginTop: wxSc(SPACING.xs),
  },
  matchedDate: { fontSize: wxMs(FONT_SIZES.xs), color: COLORS.textMuted, fontStyle: "italic" },
  imageSection: { alignItems: "center", width: wxSc(90) },
  imageContainer: { marginBottom: wxSc(SPACING.sm) },
  tournamentImage: { width: wxSc(90), height: wxSc(90), borderRadius: RADIUS.md },
  placeholderImage: {
    width: wxSc(90), height: wxSc(90),
    borderRadius: RADIUS.md,
    backgroundColor: COLORS.surface,
    alignItems: "center", justifyContent: "center",
    borderWidth: 1, borderColor: COLORS.border,
  },
  placeholderText: { fontSize: wxMs(32) },
  shareButton: {
    flexDirection: "row", alignItems: "center",
  ...
  shareIcon: { fontSize: wxMs(FONT_SIZES.sm), marginRight: wxSc(SPACING.xs) },
  shareText: { fontSize: wxMs(FONT_SIZES.xs), color: COLORS.primary, fontWeight: "600" },
  emptyState: {
    flex: 1, alignItems: "center", justifyContent: "center",
    paddingVertical: wxSc(SPACING.xl * 2),
    paddingHorizontal: wxSc(SPACING.lg),
  },
  emptyIcon: { fontSize: wxMs(60), marginBottom: wxSc(SPACING.md) },
  emptyTitle: {
    fontSize: wxMs(FONT_SIZES.lg), color: COLORS.text,
    fontWeight: "700", marginBottom: wxSc(SPACING.sm), textAlign: "center",
  },
  emptySubtitle: {
    fontSize: wxMs(FONT_SIZES.md), color: COLORS.textSecondary,
    textAlign: "center", lineHeight: wxMs(FONT_SIZES.md) * 1.5,
  ...
  clearSearchText: { color: COLORS.white, fontSize: wxMs(FONT_SIZES.sm), fontWeight: "600" },
});
