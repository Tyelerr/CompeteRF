...
export default function BarOwnerVenuesScreen() {
  ...
  const handleVenuePress = (venueId: number) => {
    router.push(`/admin/edit-venue/${venueId}` as any);
  };

  const handleManageTables = (venueId: number) => {
    router.push(`/admin/edit-venue/${venueId}?tab=tables` as any);
  };

  const handleManageDirectors = (venueId: number) => {
    router.push(`/admin/edit-venue/${venueId}?tab=directors` as any);
  };

  const handleCreateVenue = () => {
    router.push("/admin/create-venue" as any);
  };
