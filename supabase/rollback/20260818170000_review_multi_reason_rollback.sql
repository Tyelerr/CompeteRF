-- Rollback for 20260818170000_review_multi_reason.sql
-- Restores the single-reason text RPC signature and drops selected_reasons.
...
alter table public.tournament_reviews drop column if exists selected_reasons;
