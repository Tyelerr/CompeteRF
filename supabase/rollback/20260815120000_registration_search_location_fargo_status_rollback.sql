-- 20260815120000_registration_search_location_fargo_status_rollback.sql
-- Rollback for 20260815120000. Restores search + recents RPCs to their 20260813 shape
-- (id_auto, no fargo_status / home_city / home_state). Revert app code that reads the
-- new fields BEFORE running this.
