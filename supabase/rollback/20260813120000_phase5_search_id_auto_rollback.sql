-- 20260813120000_phase5_search_id_auto_rollback.sql
-- Rollback for 20260813120000_phase5_search_id_auto.sql.
-- Restores search_players_for_registration and get_recent_players_for_registration to
-- their 20260809 shape (no id_auto column). Run by hand ONLY if the id_auto extension
-- must be reverted, and only after any app code that reads id_auto has been reverted.
