...
const styles = StyleSheet.create({
  ...
  title: { fontSize: moderateScale(FONT_SIZES.xxl), fontWeight: "700", color: COLORS.text },
  spacer: { flex: 1 },
  form: {},
  forgotPassword: { alignSelf: "flex-end", marginBottom: scale(SPACING.md), marginTop: -scale(SPACING.xs) },
  forgotPasswordText: { color: COLORS.primary, fontSize: moderateScale(FONT_SIZES.sm), fontWeight: "500" },
  error: { color: COLORS.error, fontSize: moderateScale(FONT_SIZES.sm), marginBottom: scale(SPACING.md) },
  footer: { flexDirection: "row", justifyContent: "center", marginTop: scale(SPACING.lg) },
