...
export default function CreateEditAlertScreen() {
  ...
  // ── Keyboard / scroll UX ────────────────────────────────────────────────────
  // onLayout on each fieldContainer records its Y offset as the form renders.
  // onFocus scrolls to that stored Y — no measureLayout, no findNodeHandle,
  // fully compatible with the New Architecture / Fabric renderer.
  ...
  useEffect(() => {
    if (isEditMode && alertId) loadAlert(alertId);
  }, [alertId]);
  ...
  const generatePreview = () =>
    searchAlertService.generateAlertDescription(formToCriteria(form));
        ...
        >
          ...
          <View style={styles.content}>
            ...
            <View style={styles.section}>
              ...
              <View
                style={styles.fieldContainer}
                onLayout={(e) => { fieldOffsets.current["description"] = e.nativeEvent.layout.y; }}
              >
            ...
            <View style={styles.section}>
              ...
              <View
                style={styles.fieldContainer}
                onLayout={(e) => { fieldOffsets.current["equipment"] = e.nativeEvent.layout.y; }}
              >
            ...
            <View style={styles.section}>
              ...
              <View style={styles.rowFields}>
                <View
                  style={[styles.fieldContainer, styles.fieldHalf]}
                  onLayout={(e) => { fieldOffsets.current["entryFeeMin"] = e.nativeEvent.layout.y; }}
                >
                ...
                <View
                  style={[styles.fieldContainer, styles.fieldHalf]}
                  onLayout={(e) => { fieldOffsets.current["entryFeeMax"] = e.nativeEvent.layout.y; }}
                >
              ...
              <View
                style={styles.fieldContainer}
                onLayout={(e) => { fieldOffsets.current["fargoMax"] = e.nativeEvent.layout.y; }}
              >
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.sectionHint}>Tap to cycle: Any → Yes → No → Any</Text>
              <ToggleRow
...
const styles = StyleSheet.create({
  ...
  header: { padding: SPACING.md, paddingTop: SPACING.xl + SPACING.lg, alignItems: "center" },
  ...
  togglePill: {
    ...
    borderWidth: 1, borderColor: COLORS.border, minWidth: 50, alignItems: "center",
  },
  ...
  cancelButtonText: { fontSize: FONT_SIZES.md, color: COLORS.text, fontWeight: "600" },
  saveButton: {
    flex: 1, paddingVertical: SPACING.md, borderRadius: RADIUS.md,
    alignItems: "center", justifyContent: "center",
    backgroundColor: COLORS.primary,
  },
  saveButtonText: { fontSize: FONT_SIZES.md, color: COLORS.white, fontWeight: "600" },
