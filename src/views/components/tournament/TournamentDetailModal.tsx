            ...
            <View style={s.topSection}>
              ...
              <View style={s.imageSection}>
                ...
                {profile?.id_auto && tournament && (
                  ...
                  >
                    <Ionicons
                      name={isFavorited(tournament.id) ? "heart" : "heart-outline"}
                      size={44}
                      color={isFavorited(tournament.id) ? "#E53935" : COLORS.textSecondary}
                    />
                  </TouchableOpacity>
                )}
              </View>
...
const s = StyleSheet.create({
  ...
  errorText: { color: COLORS.error, fontSize: FONT_SIZES.md, textAlign: "center" },
  deletedBanner: {
    backgroundColor: COLORS.error, padding: SPACING.md,
    borderRadius: RADIUS.md, marginBottom: SPACING.md,
  },
  deletedText: { color: COLORS.white, fontSize: FONT_SIZES.sm, fontWeight: "600", textAlign: "center" },
  hiddenBanner: {
    backgroundColor: "#E53935", padding: SPACING.md, borderRadius: RADIUS.md,
    marginBottom: SPACING.md, flexDirection: "row", alignItems: "center",
    justifyContent: "center", gap: SPACING.xs,
  },
  hiddenText: { color: "#fff", fontSize: FONT_SIZES.sm, fontWeight: "700" },
  topSection: { flexDirection: "row", marginBottom: SPACING.md, alignItems: "flex-start" },
  leftContent: { flex: 1, marginRight: SPACING.sm },
  badges: { flexDirection: "row", flexWrap: "wrap", gap: SPACING.xs, marginBottom: SPACING.sm },
  idBadge: {
    backgroundColor: "#000", paddingVertical: 2, paddingHorizontal: SPACING.sm,
    borderRadius: RADIUS.sm, borderWidth: 1, borderColor: COLORS.border,
  },
  idText: { color: COLORS.white, fontSize: FONT_SIZES.xs, fontWeight: "700" },
  gameTypeBadge: { backgroundColor: COLORS.primary, paddingVertical: 2, paddingHorizontal: SPACING.sm, borderRadius: RADIUS.sm },
  gameTypeText: { color: COLORS.white, fontSize: FONT_SIZES.xs, fontWeight: "600", textTransform: "uppercase" },
  formatBadge: { backgroundColor: COLORS.surface, paddingVertical: 2, paddingHorizontal: SPACING.sm, borderRadius: RADIUS.sm },
  formatText: { color: COLORS.text, fontSize: FONT_SIZES.xs, textTransform: "capitalize" },
  recurringBadge: { backgroundColor: COLORS.surface, paddingVertical: 2, paddingHorizontal: SPACING.sm, borderRadius: RADIUS.sm },
  ...
  description: { fontSize: FONT_SIZES.sm, color: COLORS.textSecondary, lineHeight: 20 },
  ...
  viewImageButton: {
    ...
    borderWidth: 1, borderRadius: RADIUS.sm, paddingVertical: 3,
    paddingHorizontal: SPACING.sm, alignItems: "center",
  },
  viewImageText: { fontSize: FONT_SIZES.xs, color: COLORS.primary, fontWeight: "600" },
  favoriteButton: {
  ...
  sectionTitle: { fontSize: FONT_SIZES.sm, fontWeight: "600", color: COLORS.text, marginBottom: SPACING.sm },
  ...
  directorIdBadge: {
    ...
    borderRadius: RADIUS.sm, paddingVertical: 2, paddingHorizontal: SPACING.sm,
  },
  directorIdText: { fontSize: FONT_SIZES.xs, color: COLORS.primary, fontWeight: "700" },
  venueName: { fontSize: FONT_SIZES.sm, fontWeight: "600", color: COLORS.text, marginBottom: SPACING.xs },
  venueAddress: { fontSize: FONT_SIZES.sm, color: COLORS.textSecondary },
  venueActions: { flexDirection: "row", gap: SPACING.sm, marginTop: SPACING.sm },
  chipCard: {
    borderWidth: 1.5, borderColor: COLORS.primary, borderRadius: RADIUS.md,
    padding: SPACING.md, marginBottom: 10, alignItems: "center",
  },
  chipTitle: { fontSize: FONT_SIZES.sm, fontWeight: "800", color: COLORS.text, textAlign: "center", letterSpacing: 1, marginBottom: SPACING.sm },
  chipLine: { fontSize: FONT_SIZES.sm, fontWeight: "600", color: COLORS.text, paddingVertical: 2, textAlign: "center" },
  chipLineCount: { fontWeight: "800", color: COLORS.primary },
  disclaimerText: {
    fontSize: 11, color: COLORS.textSecondary, textAlign: "center",
    marginTop: SPACING.md, lineHeight: 16, opacity: 0.6,
  },
  bottomBar: {
  ...
  shareButtonText: { color: COLORS.primary, fontSize: FONT_SIZES.sm, fontWeight: "600" },
  reportButton: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    gap: 4, paddingVertical: SPACING.md, paddingHorizontal: SPACING.md,
    borderRadius: 12, borderWidth: 1, borderColor: "#E53935",
    backgroundColor: "rgba(229, 57, 53, 0.1)",
  },
  reportButtonText: { fontSize: FONT_SIZES.sm, fontWeight: "600", color: "#E53935" },
  closeBtn: { flex: 1, backgroundColor: COLORS.error, borderRadius: 12, paddingVertical: SPACING.md, alignItems: "center" },
  closeBtnText: { color: COLORS.white, fontSize: FONT_SIZES.sm, fontWeight: "700" },
});