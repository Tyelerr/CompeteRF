...
const styles = StyleSheet.create({
  container: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: scale(SPACING.md), borderBottomWidth: 1, borderBottomColor: COLORS.border },
  label: { fontSize: moderateScale(FONT_SIZES.md), color: COLORS.text, fontWeight: "500" },
