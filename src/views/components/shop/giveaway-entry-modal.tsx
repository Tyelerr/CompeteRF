...
const legalStyles = StyleSheet.create({
  mobileModalOuter: { flex: 1, justifyContent: "center", alignItems: "center", padding: wxSc(24), backgroundColor: "rgba(0,0,0,0.7)" },
  mobileCard: { backgroundColor: "#0F1117", borderRadius: wxSc(20), width: "100%", maxWidth: 480, height: "82%" as any, borderWidth: 1, borderColor: COLORS.cardBorder, flexDirection: "column" as any },
  ...
  headerTitle: { color: COLORS.white, fontSize: wxMs(FONT_SIZES.lg), fontWeight: "700" },
  divider: { height: 1, backgroundColor: COLORS.cardBorder },
  scrollView: { flex: 1 },
  scrollContent: { padding: wxSc(SPACING.xl), paddingBottom: wxSc(SPACING.lg) },
...
const styles = StyleSheet.create({
  ...
  mobileModalOuter: { flex: 1, justifyContent: "center", alignItems: "center", padding: wxSc(20), backgroundColor: "rgba(0,0,0,0.6)" },
  mobileCard: { width: "100%", maxWidth: 480, height: "78%" as any, backgroundColor: COLORS.background, borderRadius: wxSc(20), borderWidth: 1, borderColor: COLORS.cardBorder, overflow: "hidden", shadowColor: "#000", shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.5, shadowRadius: 24 },
  ...
  identityDetail: { color: COLORS.gray, fontSize: wxMs(FONT_SIZES.sm), marginTop: 1 },
  editChip: { paddingHorizontal: wxSc(SPACING.md), paddingVertical: wxSc(SPACING.sm), borderRadius: wxSc(8), borderWidth: 1, borderColor: COLORS.blue },
  editChipText: { color: COLORS.blue, fontSize: wxMs(FONT_SIZES.sm), fontWeight: "600" },
  savedDisclosure: { color: COLORS.gray, fontSize: wxMs(FONT_SIZES.xs), textAlign: "center", marginBottom: wxSc(SPACING.lg) },
  disclosureBanner: { flexDirection: "row", alignItems: "flex-start", gap: wxSc(SPACING.sm), backgroundColor: COLORS.card, borderRadius: wxSc(8), padding: wxSc(SPACING.md), marginBottom: wxSc(SPACING.lg), borderWidth: 1, borderColor: COLORS.cardBorder },
  disclosureText: { flex: 1, color: COLORS.gray, fontSize: wxMs(FONT_SIZES.xs), lineHeight: wxMs(16) },
  label: { color: COLORS.white, fontSize: wxMs(FONT_SIZES.md), fontWeight: "600", marginBottom: wxSc(SPACING.sm), marginTop: wxSc(SPACING.lg) },
  input: { backgroundColor: COLORS.card, borderRadius: wxSc(10), padding: wxSc(SPACING.lg), color: COLORS.white, fontSize: wxMs(FONT_SIZES.md), borderWidth: 1, borderColor: COLORS.cardBorder },
  birthdayRow: { flexDirection: "row", gap: wxSc(SPACING.sm) },
  dropdownButton: { backgroundColor: COLORS.card, borderRadius: wxSc(10), padding: wxSc(SPACING.lg), borderWidth: 1, borderColor: COLORS.cardBorder, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  dropdownText: { color: COLORS.white, fontSize: wxMs(FONT_SIZES.sm), flex: 1 },
  ...
  dropdownList: { backgroundColor: COLORS.card, borderRadius: wxSc(12), width: "80%", maxHeight: 300, borderWidth: 1, borderColor: COLORS.cardBorder, overflow: "hidden" },
  dropdownOption: { paddingVertical: wxSc(SPACING.md), paddingHorizontal: wxSc(SPACING.lg), borderBottomWidth: 1, borderBottomColor: COLORS.cardBorder },
  dropdownOptionActive: { backgroundColor: COLORS.blue },
  dropdownOptionText: { color: COLORS.white, fontSize: wxMs(FONT_SIZES.md) },
  dropdownOptionTextActive: { fontWeight: "700" },
  checkboxSection: { marginTop: wxSc(SPACING.xl), gap: wxSc(SPACING.md) },
  checkboxRow: { flexDirection: "row", alignItems: "center", gap: wxSc(SPACING.md) },
  checkboxLabelRow: { flex: 1, flexDirection: "row", flexWrap: "wrap", alignItems: "center" },
  checkbox: { width: wxSc(24), height: wxSc(24), borderRadius: wxSc(6), borderWidth: 2, borderColor: COLORS.gray, justifyContent: "center", alignItems: "center" },
  checkboxChecked: { backgroundColor: COLORS.blue, borderColor: COLORS.blue },
  checkboxLabel: { color: COLORS.lightGray, fontSize: wxMs(FONT_SIZES.sm) },
  linkText: { color: COLORS.blue, textDecorationLine: "underline", fontSize: wxMs(FONT_SIZES.sm) },
  errorField: { color: COLORS.red, fontSize: wxMs(FONT_SIZES.xs), marginTop: wxSc(SPACING.xs) },
  errorText: { color: COLORS.red, fontSize: wxMs(FONT_SIZES.sm), marginTop: wxSc(SPACING.md), textAlign: "center" },
  bottomBar: { flexDirection: "row", padding: wxSc(SPACING.lg), gap: wxSc(SPACING.md), borderTopWidth: 1, borderTopColor: COLORS.cardBorder, paddingBottom: Platform.OS === "ios" ? 34 : wxSc(SPACING.lg) },
  submitButton: { flex: 1, backgroundColor: COLORS.blue, borderRadius: wxSc(12), paddingVertical: wxSc(SPACING.lg), alignItems: "center" },
  submitButtonDisabled: { opacity: 0.5 },
  submitButtonText: { color: COLORS.white, fontSize: wxMs(FONT_SIZES.md), fontWeight: "700" },
  cancelButton: { flex: 1, backgroundColor: COLORS.card, borderRadius: wxSc(12), paddingVertical: wxSc(SPACING.lg), alignItems: "center", borderWidth: 1, borderColor: COLORS.cardBorder },
  cancelButtonText: { color: COLORS.white, fontSize: wxMs(FONT_SIZES.md), fontWeight: "600" },
});