...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: "row", alignItems: "center", marginBottom: scale(SPACING.md) },
  icon: { fontSize: moderateScale(20), marginRight: scale(SPACING.xs) },
  title: { fontSize: moderateScale(FONT_SIZES.sm), fontWeight: "600", color: COLORS.textSecondary, letterSpacing: 1 },
  statsRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-around" },
  statItem: { flex: 1, alignItems: "center" },
  statValue: { fontSize: moderateScale(FONT_SIZES.xl), fontWeight: "700", color: COLORS.text, marginBottom: 4 },
  statLabel: { fontSize: moderateScale(FONT_SIZES.xs), color: COLORS.textMuted },
