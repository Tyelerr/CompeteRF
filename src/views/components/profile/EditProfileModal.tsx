...
const s = StyleSheet.create({
  ...
  mobileOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.75)", justifyContent: "center", alignItems: "center", paddingHorizontal: scale(24), paddingTop: scale(60), paddingBottom: scale(100) },
  mobileContainer: { backgroundColor: COLORS.background, borderRadius: scale(20), width: "100%" as any, maxWidth: 500, height: "82%" as any, overflow: "hidden" },
  ...
  footer: { flexDirection: "row", gap: scale(SPACING.sm), padding: scale(SPACING.md) },
  ...
  avatarSection: { alignItems: "center", marginBottom: scale(SPACING.lg), paddingVertical: scale(SPACING.md) },
  avatarTouchable: { marginBottom: scale(SPACING.sm) },
  avatarImage: { width: scale(120), height: scale(120), borderRadius: scale(60), borderWidth: 3, borderColor: COLORS.primary },
  avatarContainer: { width: scale(120), height: scale(120), borderRadius: scale(60), backgroundColor: COLORS.surface, borderWidth: 2, borderColor: COLORS.border, borderStyle: "dashed", justifyContent: "center", alignItems: "center" },
  avatarPlaceholderIcon: { fontSize: moderateScale(32), marginBottom: scale(SPACING.xs) },
  avatarPlaceholderText: { fontSize: moderateScale(FONT_SIZES.xs), color: COLORS.textSecondary, fontWeight: "500" },
  avatarActions: { flexDirection: "row", gap: scale(SPACING.md), marginTop: scale(SPACING.xs) },
  avatarActionButton: { paddingVertical: scale(SPACING.xs), paddingHorizontal: scale(SPACING.sm) },
  avatarActionText: { color: COLORS.primary, fontSize: moderateScale(FONT_SIZES.sm), fontWeight: "600" },
  avatarRemoveText: { color: COLORS.error, fontSize: moderateScale(FONT_SIZES.sm), fontWeight: "600" },
  form: { gap: scale(SPACING.lg) },
  nameRow: { flexDirection: "row", gap: scale(SPACING.sm) },
  nameField: { flex: 1 },
  fieldContainer: { gap: scale(SPACING.sm) },
  fieldLabel: { fontSize: moderateScale(FONT_SIZES.sm), color: COLORS.text, fontWeight: "500" },
  ...
  disabledHint: { fontSize: moderateScale(FONT_SIZES.xs), color: COLORS.textMuted, marginTop: -scale(SPACING.xs) },
  inputError: { borderColor: COLORS.error, backgroundColor: COLORS.error + "10" },
  fieldError: { color: COLORS.error, fontSize: moderateScale(FONT_SIZES.xs), marginTop: -scale(SPACING.sm) },
  infoContainer: { flexDirection: "row", backgroundColor: COLORS.surface, borderRadius: RADIUS.md, padding: scale(SPACING.md), borderWidth: 1, borderColor: COLORS.border, alignItems: "flex-start" },
  infoIcon: { fontSize: moderateScale(FONT_SIZES.md), marginRight: scale(SPACING.sm), marginTop: 2 },
  infoText: { flex: 1, fontSize: moderateScale(FONT_SIZES.sm), color: COLORS.textSecondary, lineHeight: moderateScale(18) },
  changesIndicator: { marginTop: scale(SPACING.lg), backgroundColor: COLORS.primary + "20", borderColor: COLORS.primary, borderWidth: 1, borderRadius: RADIUS.md, padding: scale(SPACING.sm), alignItems: "center" },
  changesText: { color: COLORS.primary, fontSize: moderateScale(FONT_SIZES.sm), fontWeight: "500" },
  deleteSection: { marginTop: scale(SPACING.xl), paddingTop: scale(SPACING.md) },
  deleteDivider: { height: 1, backgroundColor: COLORS.error + "30", marginBottom: scale(SPACING.lg) },
  deleteSectionTitle: { fontSize: moderateScale(FONT_SIZES.md), fontWeight: "600", color: COLORS.error, marginBottom: scale(SPACING.xs) },
  deleteSectionDescription: { fontSize: moderateScale(FONT_SIZES.sm), color: COLORS.textSecondary, lineHeight: moderateScale(18), marginBottom: scale(SPACING.md) },
  deleteAccountButton: { alignItems: "center", paddingVertical: scale(SPACING.md), borderRadius: RADIUS.md, borderWidth: 1, borderColor: COLORS.error + "40", backgroundColor: COLORS.error + "10" },
  deleteAccountText: { color: COLORS.error, fontSize: moderateScale(FONT_SIZES.sm), fontWeight: "600" },
});
