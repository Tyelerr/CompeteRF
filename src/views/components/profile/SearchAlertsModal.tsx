      ...
      <ScrollView ref={scrollRef} style={{ flex: 1 }} contentContainerStyle={s.formScrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag">
        ...
        <View style={s.section}>
          ...
          <View style={s.fieldContainer} onLayout={(e) => { fieldOffsets.current["name"] = e.nativeEvent.layout.y; }}>
            ...
            <TextInput allowFontScaling={false} style={s.textInput} placeholder={'"9-Ball in Arizona"'} placeholderTextColor={COLORS.textMuted} value={form.name} onChangeText={(v) => updateField("name", v)} onFocus={() => scrollToField("name")} editable={!saving} autoCapitalize="words" maxLength={100} />
          </View>
...
const s = StyleSheet.create({
  ...
  sheetHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: wxSc(SPACING.lg), paddingTop: wxSc(SPACING.lg), paddingBottom: wxSc(SPACING.md) },
  sheetHeaderTitle: { color: COLORS.text, fontSize: wxMs(FONT_SIZES.lg), fontWeight: "700", letterSpacing: 1, flex: 1 },
  closeButton: { width: 40, height: 40, justifyContent: "center", alignItems: "center" },
  closeButtonText: { color: COLORS.textSecondary, fontSize: wxMs(20), fontWeight: "600" },
  ...
  statsBar: { flexDirection: "row", justifyContent: "space-around", paddingVertical: wxSc(SPACING.lg), borderBottomWidth: 1, borderBottomColor: COLORS.border },
  statItem: { alignItems: "center" },
  statValue: { fontSize: wxMs(FONT_SIZES.xl), fontWeight: "700", color: COLORS.primary },
  statLabel: { fontSize: wxMs(FONT_SIZES.sm), color: COLORS.textSecondary, marginTop: 2 },
  createButtonWrapper: { padding: wxSc(SPACING.md) },
  createButton: { backgroundColor: COLORS.primary, paddingVertical: wxSc(SPACING.md), borderRadius: RADIUS.md, alignItems: "center" },
  createButtonText: { color: COLORS.white, fontSize: wxMs(FONT_SIZES.md), fontWeight: "600" },
  listContent: { paddingBottom: wxSc(SPACING.xl) },
  listContentEmpty: { flexGrow: 1 },
  alertCard: { backgroundColor: COLORS.backgroundCard, borderRadius: RADIUS.lg, padding: wxSc(SPACING.lg), marginHorizontal: wxSc(SPACING.md), marginBottom: wxSc(SPACING.md), borderWidth: 1, borderColor: COLORS.border },
  cardTopRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: wxSc(SPACING.sm) },
  alertName: { fontSize: wxMs(FONT_SIZES.lg), fontWeight: "700", color: COLORS.text, flex: 1, marginRight: wxSc(SPACING.sm) },
  onOffBadge: { paddingHorizontal: wxSc(SPACING.md), paddingVertical: wxSc(SPACING.xs), borderRadius: RADIUS.md },
  onBadge: { backgroundColor: COLORS.primary },
  offBadge: { backgroundColor: COLORS.textMuted + "40" },
  onOffText: { fontSize: wxMs(FONT_SIZES.sm), fontWeight: "700" },
  onText: { color: COLORS.white },
  offText: { color: COLORS.textMuted },
  alertDescription: { fontSize: wxMs(FONT_SIZES.md), color: COLORS.textSecondary, lineHeight: wxMs(20), marginBottom: wxSc(SPACING.xs) },
  matchInfo: { fontSize: wxMs(FONT_SIZES.sm), color: COLORS.textMuted, marginBottom: wxSc(SPACING.lg) },
  actionRow: { flexDirection: "row", gap: wxSc(SPACING.sm) },
  actionButton: { flex: 1, paddingVertical: wxSc(SPACING.sm), borderRadius: RADIUS.md, alignItems: "center", justifyContent: "center" },
  actionOutline: { borderWidth: 1, borderColor: COLORS.border },
  actionOutlineText: { fontSize: wxMs(FONT_SIZES.sm), fontWeight: "600", color: COLORS.text },
  actionDelete: { borderWidth: 1, borderColor: COLORS.error + "60", backgroundColor: COLORS.error + "10" },
  actionDeleteText: { fontSize: wxMs(FONT_SIZES.sm), fontWeight: "600", color: COLORS.error },
  emptyState: { flex: 1, alignItems: "center", justifyContent: "center", paddingVertical: wxSc(SPACING.xl * 2), paddingHorizontal: wxSc(SPACING.lg) },
  emptyIcon: { fontSize: wxMs(60), marginBottom: wxSc(SPACING.md) },
  emptyTitle: { fontSize: wxMs(FONT_SIZES.lg), color: COLORS.text, fontWeight: "600", marginBottom: wxSc(SPACING.sm), textAlign: "center" },
  emptySubtitle: { fontSize: wxMs(FONT_SIZES.md), color: COLORS.textSecondary, textAlign: "center", lineHeight: wxMs(20) },
  errorContainer: { backgroundColor: COLORS.error + "20", padding: wxSc(SPACING.md), marginHorizontal: wxSc(SPACING.md), marginBottom: wxSc(SPACING.md), borderRadius: RADIUS.md, borderWidth: 1, borderColor: COLORS.error, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  errorText: { color: COLORS.error, fontSize: wxMs(FONT_SIZES.sm), flex: 1 },
  retryButton: { backgroundColor: COLORS.error, paddingHorizontal: wxSc(SPACING.md), paddingVertical: wxSc(SPACING.sm), borderRadius: RADIUS.sm },
  retryText: { color: COLORS.white, fontSize: wxMs(FONT_SIZES.sm), fontWeight: "600" },
  formScrollContent: { padding: wxSc(SPACING.md), paddingBottom: wxSc(SPACING.xl) },
  section: { marginBottom: wxSc(SPACING.lg), backgroundColor: COLORS.backgroundCard, borderRadius: RADIUS.lg, padding: wxSc(SPACING.lg), borderWidth: 1, borderColor: COLORS.border },
  sectionTitle: { fontSize: wxMs(FONT_SIZES.md), fontWeight: "700", color: COLORS.text, marginBottom: wxSc(SPACING.md), textTransform: "uppercase", letterSpacing: 0.5 },
  sectionHint: { fontSize: wxMs(FONT_SIZES.xs), color: COLORS.textMuted, marginBottom: wxSc(SPACING.md), marginTop: -wxSc(SPACING.sm) },
  fieldContainer: { marginBottom: wxSc(SPACING.md) },
  fieldLabel: { fontSize: wxMs(FONT_SIZES.sm), color: COLORS.text, fontWeight: "500", marginBottom: wxSc(SPACING.sm) },
  required: { color: COLORS.error },
  fieldHint: { fontSize: wxMs(FONT_SIZES.xs), color: COLORS.primary, marginTop: wxSc(SPACING.xs) },
  ...
  rowFields: { flexDirection: "row", gap: wxSc(SPACING.md) },
  fieldHalf: { flex: 1 },
  switchRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: wxSc(SPACING.sm) },
  switchInfo: { flex: 1, marginRight: wxSc(SPACING.md) },
  switchDescription: { fontSize: wxMs(FONT_SIZES.xs), color: COLORS.textMuted, marginTop: 2 },
  toggleRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: wxSc(SPACING.md), borderBottomWidth: 1, borderBottomColor: COLORS.border },
  toggleInfo: { flex: 1, marginRight: wxSc(SPACING.md) },
  toggleLabel: { fontSize: wxMs(FONT_SIZES.sm), fontWeight: "500", color: COLORS.text },
  toggleDescription: { fontSize: wxMs(FONT_SIZES.xs), color: COLORS.textMuted, marginTop: 2 },
  togglePill: { paddingHorizontal: wxSc(SPACING.md), paddingVertical: wxSc(SPACING.xs), borderRadius: RADIUS.sm, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, minWidth: 50, alignItems: "center" },
  ...
  footer: { flexDirection: "row", gap: wxSc(SPACING.sm), paddingHorizontal: wxSc(SPACING.md), paddingTop: wxSc(SPACING.sm), paddingBottom: wxSc(SPACING.lg) },
  saveButton: { flex: 1, paddingVertical: wxSc(SPACING.md + 2), borderRadius: RADIUS.md, alignItems: "center", justifyContent: "center", backgroundColor: COLORS.primary },
  saveButtonText: { fontSize: wxMs(FONT_SIZES.md), color: COLORS.white, fontWeight: "700" },
  cancelButton: { flex: 1, paddingVertical: wxSc(SPACING.md + 2), borderRadius: RADIUS.md, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: COLORS.error },
  cancelButtonText: { fontSize: wxMs(FONT_SIZES.md), color: COLORS.error, fontWeight: "600" },
